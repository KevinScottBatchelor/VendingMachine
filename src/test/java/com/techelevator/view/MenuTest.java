...
public class MenuTest {
	...
	public void displays_a_list_of_menu_options_and_prompts_user_to_make_a_choice() {
		Object[] options = new Object[] { Integer.valueOf(3), "Blind", "Mice", "hiddenOption" };
	...
	public void returns_object_corresponding_to_user_choice() {
		...
		Integer[] options = new Integer[] { Integer.valueOf(123), expected, Integer.valueOf(789), Integer.valueOf(234) };
	...
	public void redisplays_menu_if_user_does_not_choose_valid_option() {
		Object[] options = new Object[] { "Larry", "Curly", "Moe", "hidden" };
	...
	public void redisplays_menu_if_user_chooses_option_less_than_1() {
		Object[] options = new Object[] { "Larry", "Curly", "Moe", "hiddenOption" };
